...
load("sim_params.rda") #DEGs, oracle
objs <- load("simdata.rda") 
```
...
## internal comparison of K. It takes about 2G memory and about one
## hour to finish. HTK stands for Hypothesis Testing with different
## Ks.
set.seed(12345)
ns <- c(50, 60, 70)
nreps <- 100; Ks <- 1:12
